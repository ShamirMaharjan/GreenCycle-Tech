                        ...
                        <div className="mt-6">
                            ...
                            {reminders.length === 0 ? (
                                ...
                                reminders.map((reminder, index) => {
                                    const formattedDate = format(new Date(reminder.date), 'dd MMMM yyyy');
                                    return (
                                        <div key={index} className="border border-gray-200 rounded-lg p-4 mb-4">
                                            <div className="font-medium">{formattedDate}</div>
                                            <div className="text-gray-700">Location: {reminder.location}</div>
                                            <div className="text-gray-700">Description: {reminder.description}</div>
                                        </div>
                                    );
                                })
                            )}
